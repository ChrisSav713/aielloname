          ...
          <div className='px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12'>
            ...
            <div>
              <div className='relative mt-10'>
                ...
                <a
                  href='#'
                  className='flex w-full items-center justify-center gap-3 rounded-md border-opacity-100 border-2 border-black border-solid bg-white px-3 py-1.5 text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]'
                >
                  <img
                    className='w-5 h-5'
                    aria-hidden='true'
